...
function App() {
  ...
  return (
    ...
    <div className="bg-gray-400 w-2xl h-36 text-amber-900 rounded-lg">
      <div>
        <input type='text' value={password} className=' p-1.5 rounded-lg h-10 bg-white m-2 w-lg'readOnly />
        <button  onClick={copypasswordToClipboard} className='cursor-pointer bg-blue-400 h-10 w-16 rounded-lg'>copy</button>
      </div>
        <div>
